...
cap1.set(3,widthImg) # width id number is 3
cap1.set(4,heightImg) # height id number is 4
cap1.set(10,150) # brightness id number is 100
...
while True:
    ...
    biggest = getContours(imgThreshold, imgContour)
    if biggest.size != 0:
